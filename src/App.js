...
function App() {
  ...
  const changeColorFooter = () => mode === "modo-claro" ? "cor-claro" : "cor-escuro"
  const changeBackgroundButton = () => mode === "modo-claro" ? "button-modo-claro" : "button-modo-escuro"
  const changeIcons = () => mode === "modo-claro" ? moon : sun;
  const changeBackgroundSXT = () => mode === "modo-claro" ?  "secao-corClaroSXT" : "secao-corEscuroSXT"
  ...
  return (
    <div className="App">
      ...
      <main>
        ...
        <SecaoExperienciaTrabalho mode={mode}
